...
(with-slick-colors
 (lambda ()
   (custom-theme-set-faces
    ...
    `(fringe ((t (:foreground ,slick-bw-0 :background ,slick-bw+3))))
    ...
    ;; syntax highlighting
    `(font-lock-builtin-face ((t (:foreground ,slick-green-2))))
    `(font-lock-regexp-grouping-backslash ((t (:weight bold :foreground ,slick-green-1 :inherit (bold)))))
    `(font-lock-function-name-face ((t (:foreground ,slick-green-2))))
    ...
    `(font-lock-keyword-face ((t (:weight bold :foreground ,slick-pink+1))))
    ...
    `(font-lock-variable-name-face ((t (:foreground ,slick-orange-1))))
    ...
    `(mode-line-inactive ((t (:weight light :box (:line-width -1 :color nil :style released-button) :foreground ,slick-bw+1 :background ,slick-bw+3 :inherit (mode-line)))))

    ;; magit
    `(magit-branch ((t (:inherit magit-header :foreground ,slick-blue-0 :weight bold))))
    `(magit-diff-del ((t (:inherit diff-removed :foreground ,slick-pink-0 :background ,slick-bw+3))))
    `(magit-diff-add ((t (:inherit diff-added :foreground ,slick-green-1 :background ,slick-bw+3))))
    ...
    `(match ((t (:weight bold :foreground ,slick-green-1 :background ,slick-bw+3))))
    ...
    ;; default
    `(default ((t (:family "Source Code Pro" :foundry "apple" :height 120 :foreground ,slick-bw-2 :background ,slick-bw+3)))))))

(provide-theme 'slick-light)
